...
<transition name="quizzes">
    <div class="quizzes">
        ...
        <views class="subjects" ref="subjects" @change="changeSubject">
            <div v-for="subject in views">
                <div class=stuff></div>
                <div class=options>
                    {{subject.order || ''}}
                </div>
...
export default {
    ...
    components: {Views},
    computed: {
        ...mapGetters(['type', 'length', 'view', 'currentOrder', 'currentIndex', 'remaining', 'hasAnswer', 'hasReport', 'isAssignment', 'isViewCard'])
    },
    methods: {
        ...mapMutations({
            setType: 'SET_TYPE',
