...
const data = {
    data: {
        ...
        qsAll: [
            ...
            {part: 1, order: 28, title: 'detrimental', type: 0, note: '词汇测试：选择正确的释义', options: [{op_key: 'A', op_content: '有益的'}, {op_key: 'B', op_content: '有趣的'}, {op_key: 'C', op_content: '有害的'}, {op_key: 'D', op_content: 'I don’t know'}], stuff: {text: [], audio: [], images: []}},
